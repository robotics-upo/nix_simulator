 ...
 *
*/
#ifndef GAZEBO_PLUGINS_TRACKEDVEHICLEPLUGIN_ROS_HH_
#define GAZEBO_PLUGINS_TRACKEDVEHICLEPLUGIN_ROS_HH_
...
namespace gazebo
{
  class TrackedVehiclePluginROSPrivate;

  /// \class TrackedVehiclePluginROS TrackedVehiclePluginROS.hh
  ...
  class TrackedVehiclePluginROS : public ModelPlugin
  {
    /// \brief Default Contstuctor
    public: TrackedVehiclePluginROS();

    /// \brief Destructor
    public: virtual ~TrackedVehiclePluginROS();
    ...
    private: std::unique_ptr<TrackedVehiclePluginROSPrivate> dataPtr;
