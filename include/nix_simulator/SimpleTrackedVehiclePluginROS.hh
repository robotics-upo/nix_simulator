...
#ifndef GAZEBO_SIMPLETRACKEDVEHICLEPLUGIN_ROS_HH
#define GAZEBO_SIMPLETRACKEDVEHICLEPLUGIN_ROS_HH
...
namespace gazebo {
  ...
  /// \class SimpleTrackedVehiclePluginROS SimpleTrackedVehiclePluginROS.hh
  ...
  class SimpleTrackedVehiclePluginROS :
    public TrackedVehiclePluginROS
  {
    public: SimpleTrackedVehiclePluginROS() = default;

    public: virtual ~SimpleTrackedVehiclePluginROS();
