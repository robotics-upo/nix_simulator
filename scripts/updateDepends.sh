...
sudo apt-get install gazebo9 ros-$ROS_DISTRO-gazebo-ros ros-$ROS_DISTRO-gazebo-plugins gazebo9  ros-$ROS_DISTRO-velodyne-gazebo-plugins ros-$ROS_DISTRO-twist-mux ros-$ROS_DISTRO-teleop-twist-joy ros-$ROS_DISTRO-timed-roslaunch ros-$ROS_DISTRO-octomap ros-$ROS_DISTRO-octomap-ros ros-$ROS_DISTRO-pointcloud-to-laserscan ros-$ROS_DISTRO-ira-laser-tools -y  ros-$ROS_DISTRO-ros-type-instrospection libceres-dev libgsl-dev ros-$ROS_DISTRO-costmap-2d libzmq3-dev libdw-dev
